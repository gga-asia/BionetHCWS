    ...
    public class BionetHCWS : System.Web.Services.WebService
    {
        ...
        public string step1(string jsonStr, string USER_ID, string AUTH_TOKEN)
        {
            ...
            try
            {
                ...
                if (NHI_ID == "1502031095" || NHI_ID == "1507300022" || NHI_ID == "1502051426")
                            ...
                            for (int f = 0; f < DT.Rows.Count; f++)
                            {
                                ...
                                {   // 2022/09/21 新增康知因、癌知因的Json格式
                                    ...
                                    else //下面原本的架構
                                    {
                                        ...
                                        if (DT.Rows[f]["HOS_ID"].ToString() != "574")
                                        {
                                            ...
                                            for (int i = 0; i < tble.Rows.Count; i++)
                                            {
                                                ...
                                                for (int k = 0; k < HisData.Rows.Count; k++)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        string HOSID = DT.Rows[f]["HOS_ID"].ToString();
                                                        ...
                                                        else if (tble.Rows[i]["COLNAME"].ToString() == "CHECK_RESULT_6" && HOSID != "547" && HOSID != "2004")
                                                        {
                                                            string CHECK_RESULT_6 = HisData.Rows[k][tble.Rows[i]["COLNAME"].ToString()].ToString();
                                                            if (!string.IsNullOrEmpty(CHECK_RESULT_6))
                                                                if (CHECK_RESULT_6 == "無" || CHECK_RESULT_6 == "不具" || CHECK_RESULT_6 == "未測得異常")
                                                                    CHECK_RESULT_6 = "未測得異常";
                                                                else if (CHECK_RESULT_6 == "有-異常" || CHECK_RESULT_6 == "具")
                                                                    CHECK_RESULT_6 = "異常基因型";
                                                            writer.WriteValue(CHECK_RESULT_6);
                                                        }
                                                        else
                                                        {
                                                            //string TEST = HisData.Rows[k][tble.Rows[i]["COLNAME"].ToString()].ToString();
                                        ...
                                        {
                                            if (DT.Rows[f]["ProductType"].ToString() == "FFD_M" || DT.Rows[f]["ProductType"].ToString() == "FFD_O" || DT.Rows[f]["ProductType"].ToString() == "FFD_P" || DT.Rows[f]["ProductType"].ToString() == "FFD")
                                            {
                                                string result = "";
                                                DataTable INFO = HIS_code(DT.Rows[f]["HOS_ID"].ToString(), DT.Rows[f]["ProductType"].ToString());
                                                writer.WriteStartObject();
                                                writer.WritePropertyName("HIS_ID"); writer.WriteValue(INFO.Rows[0]["Test_Code"].ToString());
                                                writer.WritePropertyName("HIS_NAME"); writer.WriteValue(INFO.Rows[0]["Test_Name"].ToString());
                                                writer.WritePropertyName("HIS_VALUE");
                                                for (int i = 0; i < tble.Rows.Count; i++)
                                                {
                                                    //2018.03.22 要Mproject不等於Y 不是大項時才輸出HisData
                                                    ...
                                                    for (int k = 0; k < HisData.Rows.Count; k++)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            if (tble.Rows[i]["COLNAME"].ToString() == "Suggest5")
                                                            {
                                                                ...
                                                                if (Suggest5 != "低風險")
                                                                {
                                                                    result += $"{tble.Rows[i]["Test_Name"].ToString()}高風險, ";
                                                                }
                                                                //writer.WriteValue(Suggest5);
                                                            }
                                                            else
                                                            {
                                                                //writer.WriteValue(HisData.Rows[k][tble.Rows[i]["COLNAME"].ToString()].ToString());
                                                                string TESTTEST = HisData.Rows[k][tble.Rows[i]["COLNAME"].ToString()].ToString();
                                                                if (TESTTEST == "未測得異常" || TESTTEST == "未見明顯異常" || TESTTEST == "低風險")
                                                                { }
                                                                else
                                                                {
                                                                    if (tble.Rows[i]["COLNAME"].ToString().StartsWith("CHECK_RESULT"))
                                                                    {
                                                                        Match match = Regex.Match(tble.Rows[i]["COLNAME"].ToString(), @"\d+");
                                                                        int value = int.Parse(match.Value);
                                                                        if ((value >= 10 && value <= 29) || value == 31)
                                                                        {
                                                                            //int s = (Convert.ToInt32(HisData.Rows[k][tble.Rows[i]["COLNAME"].ToString()].ToString()));
                                                                            float floatValue = float.Parse(HisData.Rows[k][tble.Rows[i]["COLNAME"].ToString()].ToString());
                                                                        ...
                                                                        {
                                                                            result += tble.Rows[i]["Test_Name"].ToString() + TESTTEST + ", ";
                                                                        }
                                                                    }
                                                                    else
                                                                    {
                                                                        if (tble.Rows[i]["COLNAME"].ToString() == "Suggest2" || tble.Rows[i]["COLNAME"].ToString() == "Suggest3" || tble.Rows[i]["COLNAME"].ToString() == "Suggest4")
                                                                        {
                                                                            if (HisData.Rows[k][tble.Rows[i]["COLNAME"].ToString()].ToString() != "未測得異常")
                                                                            {
                                                                                char SuggestNum = tble.Rows[i]["COLNAME"].ToString()[tble.Rows[i]["COLNAME"].ToString().Length - 1];
                                                                                string SMN1_COLNAME = $"SMN1_{SuggestNum}";
                                                                                string SNM1 = get_SMN1(SMN1_COLNAME, DT.Rows[f]["CUS_CT_ID"].ToString());
                                                                                result += $"{tble.Rows[i]["Test_Name"]}:{HisData.Rows[k][tble.Rows[i]["COLNAME"].ToString()]}, ";
                                                                                result += $"{(tble.Rows[i]["Test_Name"]).ToString().Replace("結果", "檢驗值")}:{SNM1}, ";
                                                                            }
                                                                        }
                                                                        else if (tble.Rows[i]["COLNAME"].ToString().StartsWith("SMN1_"))
                                                                        {
                                                                        }
                                                                        else
                                                                        {
                                                                            result += tble.Rows[i]["Test_Name"].ToString() + HisData.Rows[k][tble.Rows[i]["COLNAME"].ToString()].ToString() + ", ";
                                                                        }
                                                                    }
                                                                }
        ...
        public string Base64Encode(string cusCtId, string productType, string cmpName)
        {
            ...
            if (productType.Contains("SNP"))
            {
                ...
                string path2 = @"\\sma\out\" + folder + @"\" + cusCtId + "_OK.pdf";
                if (System.IO.File.Exists(path2))
                {
                    var result2 = System.IO.File.ReadAllBytes(path2);
                    return Convert.ToBase64String(result2);
        ...
        {// 2021/1/01 jeff 新增
            ...
            {//以迴圈的方式判斷細項內有沒有高風險
                ...
                if (strGA.StartsWith("CHECK_RESULT")) //其他染色體
                {
                    Match match = Regex.Match(strGA, @"\d+");
                    int value = int.Parse(match.Value);
                    if ((value >= 10 && value <= 29) || value == 31)
                    {
                        ...
                        {
                            str  = "高風險";
                            HisData.Rows[0][strGA] = "高風險";
                        }
                        else
                        {
                            str  = "低風險";
                            HisData.Rows[0][strGA] = "低風險";
                        }
                    }
                }
                                    ...
                                    , string USER_ADDR, string USER_UB_DATE, string HOS_ID)
        {
            ...
            try
            {
                ...
                //                  ",@Patient_ID, @Memo_Teacher, @EMail, @Moible, @Cus_Sex, @Addr, @UB_Date, @HOS_ID, @CreateDate)";
                cmd.CommandText = "INSERT INTO HC_CUS_DATA( JSON_SN, ExlInfoNo, Cus_Name, Cus_CID, GetBlood_D, Cus_Birth" +
                                ", Patient_ID, Memo_Teacher, EMail, Moible, Cus_Sex, Addr, UB_DATE, HOS_ID, CreateDate) " +
                                "VALUES ( @JSON_SN, @ExlInfoNo, @Cus_Name, @Cus_CID, @GetBlood_D, @Cus_Birth " +
                                ",@Patient_ID, @Memo_Teacher, @EMail, @Moible, @Cus_Sex, @Addr, @UB_Date, @HOS_ID, @CreateDate)";
        ...
        public DataTable HIS_code(string HOS_ID, string ProjectType)
        {
            DataTable dt = new DataTable();
            string HIS_TITLENEW = string.Empty;
            string strSQL = string.Empty;
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = conn;
            strSQL = " select DISTINCT Test_Code , Test_Name ";
            strSQL += " from ACER_CLOUD_CODE_LIST  ";
            strSQL += " where ProjectType ='" + ProjectType + "' ";
            strSQL += " and HOS_ID ='" + HOS_ID + "' ";
            strSQL += " and Mproject ='Y' ";
            //strSQL += " from ACER_CLOUD_CODE_LIST  ";
            cmd = new SqlCommand(strSQL, conn);
            conn.Open();
            using (SqlDataAdapter a = new SqlDataAdapter(cmd))
        ...
        public string get_SMN1(string SMN, string CUS_CT_ID)
        {
            DataTable dt = new DataTable();
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = conn;
            strSQL = $" select DISTINCT {SMN} ";
            strSQL += " FROM CUSTOMER_SMA  ";
            strSQL += " where Cus_CT_ID ='" + CUS_CT_ID + "' ";
            cmd = new SqlCommand(strSQL, conn);
            conn.Open();
            using (SqlDataAdapter a = new SqlDataAdapter(cmd))
            {
